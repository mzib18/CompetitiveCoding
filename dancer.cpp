...
bool
findCompassNeighbor(int r, int c, vector<vector<int>> &mat,multiset<pair<int,int>> *xmt, multiset<pair<int, int>> *ymt) {
...
//using namespace std;
int  move(int r, int c, vector<vector<int>> &mat, multiset<pair<int,int>> *xmt, multiset<pair<int,int>> *ymt) {
    int sum=0;
    while (true) {
        //    cout<<"//////////////"<<endl;
        //     for(int i=0;i<r;i++){
